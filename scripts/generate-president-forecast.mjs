...
const CANDIDATE_DEMOGRAPHIC_NOTES = {
  ...
  harris: { profile: "former Democratic nominee and California national Democrat", strengths: ["Black", "Asian/other", "White college"], weaknesses: ["White non-college", "18-29", "65+"] },
...
const CANDIDATE_SWING_STATE_EFFECTS = {
  ...
  harris: { CA: 0.45, GA: 0.08, NV: -0.05, AZ: -0.05, NC: -0.1, PA: -0.25, MI: -0.3, WI: -0.25 },
...
const CANDIDATE_FINANCE_PROFILES = {
  ...
  harris: { donorNetwork: 0.9, grassroots: 0.58, donorConstraint: 0.72, smallDollarShare: 0.36, source: "estimated from prior national ticket, California donor network, and post-loss renomination constraints" },
...
const PRESIDENTIAL_CANDIDATES = {
  democratic: [
    ...
    { id: "harris", name: "Kamala Harris", homeState: "CA", ideology: "moderate", favorability: 39, electability: 0.54 },
