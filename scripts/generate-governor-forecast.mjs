...
const GOVERNOR_RACES = [
  ...
  { state: "IA", incumbentParty: "R", incumbent: "Kim Reynolds", status: "Incumbent retiring", pvi: -6, lastMargin: -18.6, rating: "Toss-up", demCandidate: "Rob Sand", repCandidate: "Randy Feenstra", candidateEdge: 2.1 },
...
const GOVERNOR_CANDIDATE_STATUS = {
  ...
  IA: { dem: "Rob Sand", rep: "Randy Feenstra", demStatus: "presumptive", repStatus: "front-runner", primary: "unresolved", primaryDate: "2026-06-02", primarySummary: "Sand is treated as the Democratic presumptive nominee. Feenstra is tracked as the leading Republican option until primary results resolve the race." },
