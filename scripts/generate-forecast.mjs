...
const CANDIDATE_STATUS = {
  ...
  MT: { dem: "Seth Bodnar", rep: "Kurt Alme", demStatus: "presumptive", repStatus: "presumptive", demDisplayParty: "I", primarySummary: "Seth Bodnar is modeled as the principal non-Republican path as an independent. Kurt Alme is treated as the presumptive Republican nominee after Daines' late retirement and establishment endorsement; Montana Democrats still have an unresolved primary, but the model does not currently treat that field as the main general-election lane." },
